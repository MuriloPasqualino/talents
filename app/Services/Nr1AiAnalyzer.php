...
- **Não inclua seção, título ou bloco intitulado "Orientações Práticas"** (nem variações como "Orientações práticas", "Recomendações práticas", "O que fazer", "Sugestões de melhoria"). Não liste dicas, medidas preventivas ou ações concretas para a empresa implementar; descreva apenas o que os dados indicam sobre o cenário e os riscos.
