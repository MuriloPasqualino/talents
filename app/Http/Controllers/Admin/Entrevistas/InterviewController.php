...
namespace App\Http\Controllers\Admin\Entrevistas;
...
class InterviewController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('Admin/Entrevistas/Index', [
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Admin/Entrevistas/Create', [
    ...
    public function show(Interview $interview): Response
    {
        ...
        return Inertia::render('Admin/Entrevistas/Show', [
            'interview' => [
                'id' => $interview->id,
