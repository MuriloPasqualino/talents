...
const classes = computed(() =>
    props.active
        ? 'inline-flex items-center border-b-2 border-talents-600 px-1 pt-1 text-sm font-medium leading-5 text-slate-900 focus:outline-none focus:border-talents-700 transition duration-150 ease-in-out'
